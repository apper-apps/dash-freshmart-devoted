          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
            ...
            <div className="flex flex-wrap gap-3 mt-4 sm:mt-0">
              ...
              <Button
                variant="outline"
                icon="Table"
                onClick={() => setShowBulkPriceManager(true)}
                disabled={!products.length}
...
/>
      ...
      {showBulkPriceManager && (
        <BulkPriceManagerModal
          products={products}
          onClose={() => setShowBulkPriceManager(false)}
...
// Bulk Price Manager Modal - Phase 1: Core list view + individual edits
const BulkPriceManagerModal = ({ products, onClose, onUpdate }) => {
  ...
  // Update editing prices with auto-calculation
  ...
  // Apply individual product price update
        ...
        <div className="p-6 border-b border-gray-200 flex-shrink-0">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Phase 1: Core list view + individual edits</p>
            </div>
            <button
              onClick={onClose}
              className="text-gray-400 hover:text-gray-600 transition-colors"
                  ...
                  {paginatedProducts.map((product) => {
                    ...
                    return (
                      <tr key={product.id} className="hover:bg-gray-50">
                        ...
                        {/* Status: Pending/Updated + Timestamp */}
                        <td className="px-4 py-4">
                          <div className="space-y-1">
                            <Badge 
                              variant={
                            ...
                            >
                              {status.status === 'updated' ? 'Updated' :
                               status.status === 'pending' ? 'Pending' : 'No Changes'}
                            </Badge>
                            {status.timestamp && (
