...
return (
    ...
    <div className="mb-8">
        ...
        <p className="text-gray-600">Manage employees, track attendance, and calculate payroll
                    </p>
    </div>
    {/* Tab Navigation */}
    <div className="bg-white rounded-lg shadow-card mb-6">
        <div className="flex overflow-x-auto border-b">
            {tabs.map(tab => <button
                ...
                className={`flex items-center gap-2 px-4 md:px-6 py-4 font-medium transition-all duration-200 whitespace-nowrap ${activeTab === tab.id ? "text-primary border-b-2 border-primary bg-primary/5" : "text-gray-600 hover:text-gray-900 hover:bg-gray-50"}`}>
